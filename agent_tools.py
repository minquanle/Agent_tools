    ...
    for _ in range(max_buoc):
        ...
        if not ai_msg.tool_calls:
            if isinstance(ai_msg.content, list):
                return "".join(part.get("text", "") for part in ai_msg.content if isinstance(part, dict) and "text" in part)
...
if __name__ == "__main__":
    ...
    # ============================================================
    # NANG CAP: TRO CHUYEN TRUC TIEP
    # (Bo comment phan duoi day va comment phan cac_cau_hoi tren de chay)
    # ============================================================
    print("=" * 60)
